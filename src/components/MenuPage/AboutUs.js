        ...
        <div className="container">
            <div className="card mt-6">
                <div className="card-body container col-xxl-8 px-4 py-5">
                    ...
                    <br />
                    <p>At Breadwinner, we believe freshly baked treats have the power to bring people together, jumpstart mornings, and celebrate life's victories.We believe that a freshly baked treat can be more than just a snack; it can be the catalyst for a conversation, a shared moment of joy, or the perfect way to jumpstart your morning.  That's why we use only the finest, locally-sourced ingredients whenever possible. We pour our hearts (and a sprinkle of magic) into every creation, ensuring that every bite is a winning experience. We use only the finest ingredients to craft our delicious offerings, ensuring every bite is a winning experience.</p>
                    <br />
                    <h6><b>More than just a bakery, Breadwinner aims to be a warm and welcoming space where you can savor the taste of community.</b></h6>
                    <br />
